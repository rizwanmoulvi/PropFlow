...
transaction(tokenId: UInt64, recipientAddr: Address) {
    ...
    prepare(account: AuthAccount) {
        ...
        let collectionRef = account.borrow<&PropFlow.NFTCollection>(from: /storage/NFTCollection)
    ...
    execute {
        ...
        let receiverRef = recipient.getCapability<&{PropFlow.NFTReceiver}>(/public/NFTReceiver)
            .borrow()
        ...
        PropFlow.owners[tokenId] = recipientAddr
    }
}